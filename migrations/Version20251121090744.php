 ...
 */
final class Version20251121090744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, file_path VARCHAR(255) NOT NULL, product_id INT DEFAULT NULL, PRIMARY KEY (id))');
